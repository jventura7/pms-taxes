      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  {isEnglish
                    ...
                    : "¿Tiene preguntas? Nos encantaría saber de usted. Envíenos un mensaje y le responderemos lo antes posible."}
                </p>
              </div>
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    {isEnglish
                      ...
                      : "Llámenos durante el horario de atención"}
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="text-gray-600">
                    ...
                    <p className="text-gray-500">
                      {isEnglish ? "Sunday: Closed" : "Domingo: Cerrado"}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Contact Form */}
            <div className="bg-background border border-gray-200 rounded-3xl p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors outline-none bg-background"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-medium text-gray-700 mb-2"
                  >
                    {isEnglish ? "Service Interested In" : "Servicio de Interés"}
                  </label>
                  <select
                    id="service"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors outline-none resize-none bg-background"
                    required
                  />
                </div>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              {isEnglish
                ? "Visit our office in Manassas, Virginia"
                : "Visite nuestra oficina en Manassas, Virginia"}
            </p>
          </div>
